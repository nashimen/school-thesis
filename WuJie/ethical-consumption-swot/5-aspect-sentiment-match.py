...
if __name__ == "__main__":
    ...
    path = "test/merged-score-test.xlsx" if debug else "result/merged-score.xlsx"
    ...
    s_path = "test/aspect_sentiment_result-test.xlsx" if debug else "result/aspect_sentiment_result.xlsx"
