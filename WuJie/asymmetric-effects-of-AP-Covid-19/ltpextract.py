...
'''
  #  模型文件
ltp = ltp_api(r"C:\Users\wo\Desktop\ltp_data")
# ltp.release()  
...
data=pd.read_excel(r'C:\Users\wo\Desktop\before.xlsx',engine="openpyxl")
...
content=['Restaurant','Facility','Room','Bathroom','Sleep','Value','Cleanliness']
...
data.to_excel(r'C:\Users\wo\Desktop\done.xlsx')
