...
if __name__ == "__main__":
    ...
    data = pd.read_excel(path, usecols=[10, 14, 16, 18, 20, 22, 24, 26, 28, 39])  # 分属性评论的语料库
    ...
    # 计算tfidf
    print("开始计算tfidf")
    s_path = "test/hot_words-（是否国产）-test.csv" if debug else "result/hot_words-（是否国产）.csv"  # 分属性评论的语料库
